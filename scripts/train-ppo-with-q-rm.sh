...
export STRATEGY="${TASK}-qrm-samples-1-lr-5e-6-chunk-size-3072"
...
export LOG_DIR="log/${ACTOR_MODEL_NAME}/policy/ppo/${STRATEGY}/full/"
...
torchrun --nproc_per_node 8 policy_train_ppo_with_evaluate.py \
  --task ${TASK} \
