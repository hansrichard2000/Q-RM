...
def train_actor(
    ...
    actor_optimizer = DataParallelOptimizer(torch.optim.Adam(actor.parameters(), lr=0.075 * lr if epoch <= 1 else lr))
...
def train_critic(
    ...
    critic_optimizer = DataParallelOptimizer(torch.optim.Adam(critic.parameters(), lr=max(1e-5, lr)))
