...
from policy_train_ppo import collect_reference_buffer, collect_critic_buffer, collect_verifier_buffer, train_actor, \
    train_critic, collect_actor_buffer
from src.dataset import JsonDataset, ChatTemplateDataset
from src.evaluator import PolicyEvaluator
from src.modeling import get_parallel_model
from src.parallel.utils import setup_model_parallel, set_barrier, get_local_rank
from src.ppo.buffer import RolloutBuffer
from src.utils import masked_mean, json_load, json_dump
...
def evaluate_actor(
    ...
    if log_dir is not None and get_local_rank() == 0:
    ...
    for global_epoch in range(begin_global_epoch, epochs):
        for local_epoch in range(begin_local_epoch, local_epochs):
            ...
            if use_last_token_reward:
                ...
                print(f"Average Rewards: {masked_mean(verifier_rollout_buffer.scores, actor_rollout_buffer.action_masks)}")
